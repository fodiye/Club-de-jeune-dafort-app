...
export interface ApiAProposAPropos extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    texte_mission: Schema.Attribute.RichText;
    texte_vision: Schema.Attribute.RichText;
    titre_mission: Schema.Attribute.String;
    titre_vision: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiActiviteActivite extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: "Les activit\u00E9s de l'association";
  ...
  attributes: {
    couleur: Schema.Attribute.String & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiEquipeEquipe extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: "Les membres de l'\u00E9quipe dirigeante";
    displayName: 'Equipe';
    pluralName: 'equipes';
    singularName: 'equipe';
  };
...
export interface ApiGalerieGalerie extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Les \u00E9l\u00E9ments de la galerie';
    displayName: 'Galerie';
    pluralName: 'galeries';
  ...
  attributes: {
    ...
    ordre: Schema.Attribute.Integer;
    publishedAt: Schema.Attribute.DateTime;
    taille: Schema.Attribute.Enumeration<['normal', 'large']> &
...
export interface ApiHeroHero extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    bouton_principal_lien: Schema.Attribute.String;
    bouton_principal_texte: Schema.Attribute.String;
    bouton_secondaire_lien: Schema.Attribute.String;
    bouton_secondaire_texte: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiMembreMembre extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: "Les membres de l'association";
    displayName: 'Membre';
    pluralName: 'membres';
    singularName: 'membre';
  };
